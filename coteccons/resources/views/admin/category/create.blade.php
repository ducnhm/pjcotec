			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('admincp.menu.store') }}" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="title" onkeyup="ChangeToSlug()" class="form-control" value="{{ old('name') }}" name="name" placeholder="Tin tức">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<textarea class="form-control" rows="10" value="{{ old('desc') }}" name="desc" placeholder=""></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" name="parent_id">
										...
										<?php 
											...
											menuMulti($category,0,$char ="---|",old('name'))
