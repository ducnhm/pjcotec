				...
				<tr class="odd gradeX">
					...
					<td>
						<?php
                            ...
                            if ($active == 1 ) { ?>
                                <form action="{{route('months/active',$item->month_id)}}" method="post" accept-charset="utf-8">
					...
					{{-- edit --}}
					<a class='btn btn-info btn-xs' href="{{ URL::route('admincp.months.edit',$item->month_id) }}"><span class="glyphicon glyphicon-edit"></span> Edit</a> 

					{{-- delete --}}
					{{Form::open(array('route'=>['admincp.months.destroy', $item->month_id],'class'=>'formbutton','method' => 'DELETE','files' => true))}}
