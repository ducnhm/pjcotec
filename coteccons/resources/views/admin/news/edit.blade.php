			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('admincp.news.update',$news->new_id) }}" enctype="multipart/form-data">
						<input type="hidden" name="_method" value="put" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" id="title" onkeyup="ChangeToSlug()" class="form-control" value="{{ $news->title }}" name="title" placeholder="Tin tức">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" readonly="" id="slug" name="alias" value="{{ $news->alias }}" placeholder="slug">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<textarea class="form-control editor" rows="1000" id="editor" value="" name="desc" placeholder="">{{ $news->desc }}</textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<textarea class="form-control editor" rows="1000" id="editor" value="{{ old('content') }}" name="content" placeholder="">{{ $news->content }}</textarea>
