			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" method="post" action="{{ route('admincp.project.store') }}" enctype="multipart/form-data">

							 <input type="hidden" name="_token" value="{{csrf_token()}}" />
							 
							<div class="form-group">
								<label for="field-1" class="col-sm-2 control-label">Tên dự án</label>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"  name="address" value="{{ old('adress') }}" placeholder="09 Nguyễn Kiệm">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<textarea class="form-control" rows="20" value="{{ old('desc') }}" name="desc" placeholder=""></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<textarea class="form-control" rows="30" value="{{ old('content') }}" name="content" placeholder=""></textarea>
									<script type="text/javascript">
